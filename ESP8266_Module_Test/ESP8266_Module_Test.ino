...
char ssid[] = "FBI Secret Hideout 868";            // your network SSID (name)
char pass[] = "Spaghetti!";        // your network password
...
void setup()
{
  ...
  if (client.connect(server, 80)) {
    ...
    client.println("POST https://47989dcaec57.ngrok.io/data HTTP/1.1");
